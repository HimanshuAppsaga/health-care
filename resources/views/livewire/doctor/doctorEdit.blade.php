        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-black text-on-background tracking-tight">Edit Doctor Profile</h1>
                </div>
                <p class="text-outline font-medium text-sm sm:text-base">Update your professional information, bio, and working hours.</p>
            </div>
